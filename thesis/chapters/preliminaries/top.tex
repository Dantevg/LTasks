...
The breakfast example using the combinators from the iTasks framework \mintinline{clean}{>>-} (sequential), \mintinline{clean}{-&&-} (parallel and) and \mintinline{clean}{-||-} (parallel or) looks like this:
\begin{minted}{clean}
